            ...
            <div className="p-5">
              ...
              <div className="flex flex-col gap-2">
                <a
                  ...
                  className="w-full text-center px-4 py-2.5 bg-brand-600 text-white rounded-xl text-sm font-semibold hover:bg-brand-700 transition-all duration-200 shadow-md shadow-brand-600/20"
                >
                  Abrir tienda
                </a>
                <CopyLinkButton
